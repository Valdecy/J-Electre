...
public class ELECTRE_I {

	public static String[][] e_I_Algorithm(double[][] array, double[] weights) {

		double [][]  arrayP1        = Credibility.getCredibilityMatrixEI(array, weights);
		...
		arrayTemp = Concordance.getConcordanceMatrixEI(array, weights);
		...
		arrayTemp = Discordance.getDiscordanceMatrixEI(array);
		...
		arrayTemp = Credibility.getCredibilityMatrixEI(array, weights);
