...
//	JohnsonAlgorithm_ElementaryCyclesSearch: Modified in 01.01.2017 by Valdecy Pereira and Livia Dias de Oliveira Nepomuceno.
...
loop:
		for (int i = 0; i < adjList[v].size(); i++) {
			...
			if (w == s) {
				...
				if (cycles.size()  + 1 > InterfaceElectre.MaximumCycles){	
					break loop;
				}
