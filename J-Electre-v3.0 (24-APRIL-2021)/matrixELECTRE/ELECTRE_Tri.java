...
public class ELECTRE_Tri {
	...
	public static String[][] e_Tri_Algorithm(double[][] x, double[] p, double[] q, double[] v, double[] w, double[][] bh) {
        ...
        if (InterfaceElectre.electre == 7){
        	cut_off = InterfaceElectre.ETri_Lambda;
        }
        ...
        for (int i = 1; i < arrayCL.length; i++) {
        	arrayCL[i][0] = String.valueOf((char)(bh.length + 'A'));
        	arrayCL[i][1] = String.valueOf((char)('A'));
        }
        ...
        for (int i = 0; i < arrayPR.length; i++){
        	for (int profile = 0; profile < bh.length; profile ++){
        		...
        		if (arrayPR[i][bh.length - profile - 1] == ">"){ // 
        			arrayCL[i + 1][0] = String.valueOf((char)((bh.length - L) + 'A'));
        		}
        	}
        	L = 0;
        }
